...
def ReadSingleAdmin():
    ...
    try:
        ...
        readSingleUser = Admin.query.filter_by(ad_uid = uid).first()
...
def UpdateAdmin  ():
    ...
    try:
        ...
        updateuser = Admin.query.filter_by(ad_uid = uid).first()
...
def DeleteAdmin():
    ...
    try:
        ...
        deleteuser = Admin.query.filter_by(ad_uid=uid).first()
